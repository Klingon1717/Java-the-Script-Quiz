...
console.log('What shall I call you');
var playerName = prompt();
console.log(playerName + ' ' + 'if you want respect from anybody ever then you must complete this quiz');



console.log('Question One: When using css what is the symbol for id\? \.\# \{ \(');
var userAnsOne = prompt();
if(userAnsOne === "#"){
	correctAnswers ++;
...
var percentTotal = (correctAnswers /15)*100;
